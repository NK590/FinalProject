...
public class GroupDTO {
	...
	private int group_seq, mem_seq;
	private String group_title, group_content, group_std_key;
	private int group_max, group_memCount;
	...
	public String toString() {
		return group_seq + " : " + mem_seq + " : " + group_title
				+ " : " + group_content + " : " + group_std_key + " : " + group_max
				+ " : " + group_memCount + " : " + group_image;
	}
